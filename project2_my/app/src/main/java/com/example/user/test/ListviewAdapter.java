...
public class ListviewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(c.getResources(), R.drawable.kakao);
        icon.setImageBitmap(bitmap); //기본 카카오이미지로 아이콘
        /**이름*/
        ...
        Bitmap bm0 = BitmapFactory.decodeFile(listviewitem.getPhoto(), bfo);
        photo.setImageBitmap(bm0);
        /**텍스트*/
